...
public class DeptServiceImpl extends ServiceImpl<DeptMapper, Dept> implements IDeptService {
    ...
    /**
     * 根据用户所在行政区划，获取行政区划ztree的节点列表
     * @param adTreeByAdidLike
     * @return
     */
    @Override
    public List<ZTreeNode> adTreeByAdidLike(String adTreeByAdidLike) {
        return this.baseMapper.adTreeByAdidLike(adTreeByAdidLike);
    }
}
